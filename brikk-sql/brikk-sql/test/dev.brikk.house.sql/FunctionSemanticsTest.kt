 ...
 * brikk-sql/brikk-sql/testResources/semantics/trino-duckdb-hazards.json (live-probe-verified
 * verdicts) and brikk-sql/brikk-sql/testResources/semantics/gap-report.json (catalog gaps).
 *

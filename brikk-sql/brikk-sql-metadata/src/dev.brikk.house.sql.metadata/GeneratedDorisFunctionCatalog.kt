...
// Plus release-branch additions from 4.1.4 (ad35a140c7fd0b842f18c23300bac581f7d04326),
...
/** Doris built-in functions: 731 definitions, 829 names incl. aliases, 1436 overloads. */
...
private fun chunk4(): List<FunctionDef> = listOf(
    ...
    FunctionDef("PARSE_TO_VARIANT", FunctionKind.SCALAR, overloads = listOf(
        FunctionOverload(listOf("VARCHAR"), "VARIANT"),
    ), profile = SemanticProfile(NullPropagation.STRICT)),
...
private fun chunk6(): List<FunctionDef> = listOf(
    ...
    FunctionDef("TRY_PARSE_TO_VARIANT", FunctionKind.SCALAR, overloads = listOf(
        FunctionOverload(listOf("VARCHAR"), "VARIANT"),
    ), profile = SemanticProfile(NullPropagation.ALWAYS_NULLABLE)),
...
private fun chunk8(): List<FunctionDef> = listOf(
    ...
    FunctionDef("VECTOR_SEARCH", FunctionKind.TABLE_VALUED),
    // table_generating (28)

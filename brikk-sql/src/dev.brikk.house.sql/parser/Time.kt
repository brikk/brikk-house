...
/**
 * Port of sqlglot/time.py `TIMEZONES` — lowercase IANA timezone names (plus legacy
 * aliases), used by generator helpers (e.g. no_timestamp_sql) to decide whether a
 * string literal denotes a timezone.
 */
// sqlglot: time.TIMEZONES
val TIMEZONES: Set<String> = setOf(
    ...
    "canada/saskatchewan", "canada/yukon", "cet", "chile/continental", "chile/easterisland",
    "cst6cdt", "cuba", "eet", "egypt", "eire", "est", "est5edt", "etc/gmt", "etc/gmt+0",
    ...
    "etc/greenwich", "etc/uct", "etc/universal", "etc/utc", "etc/zulu", "europe/amsterdam",
    ...
    "europe/kaliningrad", "europe/kiev", "europe/kirov", "europe/kyiv", "europe/lisbon",
    ...
    "europe/zagreb", "europe/zaporozhye", "europe/zurich", "gb", "gb-eire", "gmt", "gmt+0",
    "gmt-0", "gmt0", "greenwich", "hongkong", "hst", "iceland", "indian/antananarivo",
    ...
    "iran", "israel", "jamaica", "japan", "kwajalein", "libya", "met", "mexico/bajanorte",
    "mexico/bajasur", "mexico/general", "mst", "mst7mdt", "navajo", "nz", "nz-chat",
    ...
    "pacific/wallis", "pacific/yap", "poland", "portugal", "prc", "pst8pdt", "roc", "rok",
    "singapore", "turkey", "uct", "universal", "us/alaska", "us/aleutian", "us/arizona",

 ...
 *
 * GENERATED by tools/gen_ast_nodes.py from sqlglot v30.17.0-93-gdcc36544a — do not edit by hand.
 */
...
open class DataType(initArgs: Args = emptyMap()) : Expression(initArgs) {
    ...
    companion object {
        ...
        // sqlglot: datatypes.DataType.BINARY_TYPES
        val BINARY_TYPES: Set<DType> = setOf(
            DType.BINARY, DType.VARBINARY, DType.TINYBLOB, DType.BLOB,
            DType.MEDIUMBLOB, DType.LONGBLOB,
        )
        ...
        val REAL_TYPES: Set<DType> = FLOAT_TYPES + setOf(
            ...
            DType.NUMBER, DType.SMALLMONEY, DType.UDECIMAL, DType.UDOUBLE,
        )

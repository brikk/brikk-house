...
private fun hazardsChunk1(): List<FunctionHazard> = listOf(
    ...
    FunctionHazard(HazardVerdict.DIVERGENT,
        hazard = "ClickHouse round() uses banker's rounding (round-half-to-EVEN): round(2.5)=2, round(-2.5)=-2; DuckDB rounds half-AWAY-from-zero: 3 and -3. roundBankers matches ClickHouse round.",
        areas = listOf("numeric"),
    ...
    FunctionHazard(HazardVerdict.DIVERGENT,
        hazard = "ClickHouse bin(5)='00000101' (zero-padded to a full byte); DuckDB bin(5)='101' (no leading zeros).",
        areas = listOf("numeric", "string"),
        provenance = "REPORT-clickhouse-differential-probe-2026-07-13.md#bin-padding"),

...
/** The 241 probe-verified (duckdb, doris) pair verdicts, in JSON order. */
...
/** duckdb->doris lookup: 241 keys (DuckDB-side names) over 241 entries. */
...
/** doris->duckdb lookup: 231 keys (Doris-side names) over 241 entries. */

#!/usr/bin/env python3
"""Generates the Doris built-in function catalog for brikk-sql from Doris's own registry.
...
OUT = ROOT / "brikk-sql" / "src" / "dev.brikk.house.sql" / "dialects" / "GeneratedDorisFunctionCatalog.kt"

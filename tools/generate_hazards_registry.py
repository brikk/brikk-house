...
Source of truth: brikk-sql/brikk-sql/testResources/semantics/*-hazards.json — one file per dialect
...
Usage: python3 tools/generate_hazards_registry.py [<json-path> ...]
       (default: every brikk-sql/brikk-sql/testResources/semantics/*-hazards.json, sorted)
"""
...
SEMANTICS_DIR = ROOT / "brikk-sql" / "brikk-sql" / "testResources" / "semantics"
OUT_DIR = ROOT / "brikk-sql" / "brikk-sql-metadata" / "src" / "dev.brikk.house.sql.metadata"
...
def generate_one(src: pathlib.Path) -> None:
    ...
    lines = [
        ...
        f"// brikk-sql/brikk-sql/testResources/semantics/{src.name} ({source_project},",

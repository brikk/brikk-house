...
Current snapshot version: **`0.9.0-SNAPSHOT`**
...
dependencies {
    implementation("dev.brikk.house:brikk-sql-jvm:0.9.0-SNAPSHOT")
    // implementation("dev.brikk.house:brikk-sql-metadata-jvm:0.9.0-SNAPSHOT") // transitive via brikk-sql-jvm
    // implementation("dev.brikk.house:brikk-sql-verify:0.9.0-SNAPSHOT")
}
```
</details>
...
`mavenCentral()` with no extra repository configuration. Latest release: **`0.8.0`**.
